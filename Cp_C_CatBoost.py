...
# 选择要预测的目标变量
target_var = 'Cp_C'  # 可以改为 'Cp_B', 'Cp_C', 'Cp_D'
...
# 创建输出目录
output_path = f"E:\\胡琰琰\\毕业论文内容\\G\\运行数据\\拟合\\C\\{target_var}_CatBoost_安全版.xlsx"
...
# 1. 创建模型保存目录
model_save_dir = r"E:\\胡琰琰\\毕业论文内容\\G\\运行数据\\拟合\\C\\保存的模型"
