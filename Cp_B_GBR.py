...
# 选择要预测的目标变量
target_var = 'Cp_B'  # 可以改为 'Cp_B', 'Cp_C', 'Cp_D'
...
# ==============================================
param_bounds = {
    'n_estimators': (270, 290),  # 最佳279在区间中间，缩小区间聚焦邻近最优区域
    'learning_rate': (0.12, 0.13),  # 最佳0.12275在原范围中间，收紧范围提升搜索精准度
    'max_depth': (7, 9),  # 最佳8是原范围下限，缩小区间控制深度以抑制过拟合
    'min_samples_split': (4, 6),  # 最佳5在区间中间，保持区间稳定分裂样本数
    'min_samples_leaf': (3, 4),  # 最佳3在区间中间，聚焦邻近区间优化叶节点样本量
    'subsample': (0.81, 0.825),  # 最佳0.8158接近原范围下限，收紧范围聚焦
    'max_features': (0.99, 1.0)  # 最佳0.9941接近1.0，聚焦高位区间
}
...
# 创建输出目录
output_path = f"E:\\胡琰琰\\毕业论文内容\\G\\运行数据\\拟合\\B\\{target_var}_GBR_安全版.xlsx"
...
# 1. 创建模型保存目录
model_save_dir = r"E:\\胡琰琰\\毕业论文内容\\G\\运行数据\\拟合\\B\\保存的模型"
